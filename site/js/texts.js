...
export const T = {
  bg: {
    ...
    season_shortest_years: (years) => `най-къс: ${years.join(", ")}`,
    season_longest_years: (years) => `най-дълъг: ${years.join(", ")}`,
  ...
  en: {
    ...
    season_shortest_years: (years) => `shortest: ${years.join(", ")}`,
    season_longest_years: (years) => `longest: ${years.join(", ")}`,
