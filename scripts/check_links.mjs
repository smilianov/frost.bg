...
// ПО ПРАВИЛО или разпознава връзката, или я съобщава като проблем с файл:ред.
// Това е цел и мярка за качество, НЕ гаранция: скриптът е евристика, не
// parser, и има измерени случаи, в които връзка се подминава без диагностика
// (виж „Останалите граници“ по-долу и редовете „ОГРАНИЧЕНИЕ, ТИХО“ в
// scripts/check_links.test.js). Шумна фалшива тревога е приемлива — вижда се
// и се решава с ограден блок за минута; тих пропуск не се вижда никога.
// Трите предни кръга паднаха все на едно и също: регулярен израз без
...
//
// ПРОЦЕНТНОТО КОДИРАНЕ НЕ СЪЗДАВА СТРУКТУРА — при РАЗДЕЛЯНЕТО и при
// КЛАСИФИКАЦИЯТА. (При крайното файлово разрешаване вече създава: сегментите
// се декодират, затова `/css%2Fapp.css` намира `site/css/app.css`, а
// `/..%2Fpackage.json` стига до файл извън site/.) Това е семантиката на
